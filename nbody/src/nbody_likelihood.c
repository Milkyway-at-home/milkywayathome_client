...
real nbMatchHistogramFiles(const char* datHist, const char* matchHist, mwbool use_veldisp)
{
    ...
    mw_printf("%0.15f %0.15f %0.15f %0.15f %0.15f\n", emd, cost_component, emd + cost_component, vel_disp, likelihood);
    free(dat);
    free(match);
    return likelihood;
}
                     ...
                     NBodyLikelihoodMethod method)
{
    ...
    mw_printf("%0.15f %0.15f %0.15f %0.15f %0.15f\n", geometry_component, cost_component, geometry_component + cost_component, velocity_dispersion_component, likelihood);
