    ...
    static const MWNamedArg argTable[] =
        {
            ...
            { "l",             LUA_TNUMBER,  NULL, FALSE,  &ctx.b   },
            ...
            { "LMCpositionX",  LUA_TNUMBER,  NULL, FALSE, &ctx.LMCpositionX  },
            { "LMCpositionY",  LUA_TNUMBER,  NULL, FALSE, &ctx.LMCpositionY  },
            { "LMCpositionZ",  LUA_TNUMBER,  NULL, FALSE, &ctx.LMCpositionZ  },
            { "LMCvelocityX",  LUA_TNUMBER,  NULL, FALSE, &ctx.LMCvelocityX  },
            { "LMCvelocityY",  LUA_TNUMBER,  NULL, FALSE, &ctx.LMCvelocityY  },
            { "LMCvelocityZ",  LUA_TNUMBER,  NULL, FALSE, &ctx.LMCvelocityZ  },
...
static const Xet_reg_pre gettersNBodyCtx[] =
{
    ...
    { "LMCpositionX",    getNumber,     offsetof(NBodyCtx, LMCpositionX)  },
    { "LMCpositionY",    getNumber,     offsetof(NBodyCtx, LMCpositionY)  },
    { "LMCpositionZ",    getNumber,     offsetof(NBodyCtx, LMCpositionZ)  },
    { "LMCvelocityX",    getNumber,     offsetof(NBodyCtx, LMCvelocityX)  },
    { "LMCvelocityY",    getNumber,     offsetof(NBodyCtx, LMCvelocityY)  },
    { "LMCvelocityZ",    getNumber,     offsetof(NBodyCtx, LMCvelocityZ)  },
...
static const Xet_reg_pre settersNBodyCtx[] =
{
    ...
    { "LMCpositionX",    setNumber,     offsetof(NBodyCtx, LMCpositionX)  },
    { "LMCpositionY",    setNumber,     offsetof(NBodyCtx, LMCpositionY)  },
    { "LMCpositionZ",    setNumber,     offsetof(NBodyCtx, LMCpositionZ)  },
    { "LMCvelocityX",    setNumber,     offsetof(NBodyCtx, LMCvelocityX)  },
    { "LMCvelocityY",    setNumber,     offsetof(NBodyCtx, LMCvelocityY)  },
    { "LMCvelocityZ",    setNumber,     offsetof(NBodyCtx, LMCvelocityZ)  },
