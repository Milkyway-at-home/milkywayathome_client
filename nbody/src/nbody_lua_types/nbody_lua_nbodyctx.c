    ...
    static const MWNamedArg argTable[] =
        {
            ...
            { "LMCposX",       LUA_TNUMBER,  NULL, FALSE, &ctx.LMCposX       },
            { "LMCposY",       LUA_TNUMBER,  NULL, FALSE, &ctx.LMCposY       },
            { "LMCposZ",       LUA_TNUMBER,  NULL, FALSE, &ctx.LMCposZ       },
            { "LMCposVX",      LUA_TNUMBER,  NULL, FALSE, &ctx.LMCposVX      },
            { "LMCposVY",      LUA_TNUMBER,  NULL, FALSE, &ctx.LMCposVY      },
            { "LMCposVZ",      LUA_TNUMBER,  NULL, FALSE, &ctx.LMCposVZ      },
...
static const Xet_reg_pre gettersNBodyCtx[] =
{
    ...
    { "LMCposX",         getNumber,     offsetof(NBodyCtx, LMCposX)       },
    { "LMCposY",         getNumber,     offsetof(NBodyCtx, LMCposY)       },
    { "LMCposZ",         getNumber,     offsetof(NBodyCtx, LMCposZ)       },
    { "LMCposVX",        getNumber,     offsetof(NBodyCtx, LMCposVX)      },
    { "LMCposVY",        getNumber,     offsetof(NBodyCtx, LMCposVY)      },
    { "LMCposVZ",        getNumber,     offsetof(NBodyCtx, LMCposVZ)      },
...
static const Xet_reg_pre settersNBodyCtx[] =
{
    ...
    { "LMCposX",         setNumber,     offsetof(NBodyCtx, LMCposX)       },
    { "LMCposY",         setNumber,     offsetof(NBodyCtx, LMCposY)       },
    { "LMCposZ",         setNumber,     offsetof(NBodyCtx, LMCposZ)       },
    { "LMCposVX",        setNumber,     offsetof(NBodyCtx, LMCposVX)      },
    { "LMCposVY",        setNumber,     offsetof(NBodyCtx, LMCposVY)      },
    { "LMCposVZ",        setNumber,     offsetof(NBodyCtx, LMCposVZ)      },
