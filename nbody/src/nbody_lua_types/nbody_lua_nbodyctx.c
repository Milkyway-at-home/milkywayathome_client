    ...
    static const MWNamedArg argTable[] =
        {
            ...
            { "BetaStatErr",   LUA_TNUMBER,  NULL, FALSE, &ctx.BetaStatErr   },
            { "VLOSStatErr",   LUA_TNUMBER,  NULL, FALSE, &ctx.VLOSStatErr   },
            { "DistStatErr",   LUA_TNUMBER,  NULL, FALSE, &ctx.DistStatErr   },
...
static const Xet_reg_pre gettersNBodyCtx[] =
{
    ...
    { "BetaStatErr",     getNumber,     offsetof(NBodyCtx, BetaStatErr)   },
    { "VLOSStatErr",     getNumber,     offsetof(NBodyCtx, VLOSStatErr)   },
    { "DistStatErr",     getNumber,     offsetof(NBodyCtx, DistStatErr)   },
...
static const Xet_reg_pre settersNBodyCtx[] =
{
    ...
    { "BetaStatErr",     setNumber,     offsetof(NBodyCtx, BetaStatErr)   },
    { "VLOSStatErr",     setNumber,     offsetof(NBodyCtx, VLOSStatErr)   },
    { "DistStatErr",     setNumber,     offsetof(NBodyCtx, DistStatErr)   },
