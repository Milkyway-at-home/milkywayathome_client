...
int main(int argc, char *argv[]){
    ...
    result += test(10000, 9);
    mw_printf(" Running Test 7: model_LMC_100\n");
    result += test(100, 10);
    mw_printf(" Running Test 8: model_LMC_1024\n");
    result += test(1024, 10);
    mw_printf(" Running Test 9: model_LMC_10000\n");
    result += test(10000, 10);
    mw_printf(" Running Test 10: model_ninkovic_100\n");
    result += test(100, 11);
    mw_printf(" Running Test 11: model_ninkovic_1024\n");
    result += test(1024, 11);
    mw_printf(" Running Test 12: model_ninkovic_10000\n");
    result += test(10000, 11);
    mw_printf(" Running Test 13: model_triaxial_100\n");
    result += test(100, 12);
    mw_printf(" Running Test 14: model_triaxial_1024\n");
    result += test(1024, 12);
    mw_printf(" Running Test 15: model_triaxial_10000\n");
    result += test(10000, 12);
