...
static const double MIN_CPU_TIME = 100.0;
...
//	int retval = get_output_file_paths(results, &output_file_name);

	return get_credit_from_wu(wu, results);
}

const char *BOINC_RCSID_f3a7a34795 = "$Id: validator_astronomy.C,v 1.1 2008/12/03 18:10:48 deselt Exp $";
