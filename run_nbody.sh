...
then
    ./milkyway_nbody \
    -f $PathToMilkyWayAtHomeClientDirectory/nbody/sample_workunits/for_developers_S.lua \
    -o $PathToMilkyWayAtHomeClientDirectory/build/bin/output.out \
    -z $PathToMilkyWayAtHomeClientDirectory/build/bin/output.hist \
