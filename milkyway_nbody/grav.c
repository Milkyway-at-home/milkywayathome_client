...
local real miya_ascal = 6.5;
local real miya_bscal = 0.26;
local real miya_mass = 4.45865888E5;
local real plu_rc = 0.7;
local real plu_mass = 1.52954402E5;
local real vhalo = 73;
local real haloq = 1.0;
local real halod = 12.0;

local real apar, qpar, spar, ppar, lpar, rpar, rcyl;
