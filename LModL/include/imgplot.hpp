...
#ifndef _IMGPLOT_HPP_
#define _IMGPLOT_HPP_
...
public:
    ...
    ImagePlot( string fileName, int pointTotal, float width, float thickness, float lum = 1. );

    ~ImagePlot();

    void readImage( string fileName, int pointTotal, float width, float thickness, float lum = 1. );
