...
if os == "linux":
    ...
    if arch == "64":
        execute(["cmake", ".", "-DCMAKE_FIND_ROOT_PATH=/srv/chroot/hardy_amd64", "-DOPENCL_LIBRARIES=/opt/AMDAPP/lib/x86_64/libOpenCL.so", "-DOPENCL_INCLUDE_DIRS=/opt/AMDAPP/include/"] + cmake_shared_flags)

    if arch == "32":
        execute(["cmake", ".", "-DBUILD_32=ON", "-DCMAKE_FIND_ROOT_PATH=/srv/chroot/hardy_i386", "-DOPENCL_LIBRARIES=/opt/AMDAPP/lib/x86/libOpenCL.so", "-DOPENCL_INCLUDE_DIRS=/opt/AMDAPP/include/"] + cmake_shared_flags)
