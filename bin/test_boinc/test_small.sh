...
echo "finished test on 11"

cp stars-12.txt stars.txt
cp astronomy_parameters-12-small.txt astronomy_parameters.txt

./$1 -np 20 -p 0.571713 12.312119 -3.305187 148.010257 22.453902 0.42035 -0.468858 0.760579 -1.361644 177.884238 23.882892 1.210639 -1.611974 8.534378 -1.361644 177.884238 10.882892 1.210639 -1.611974 8.534378 
echo "finished test on 12"

cp stars-20.txt stars.txt
cp astronomy_parameters-20-small.txt astronomy_parameters.txt
...
echo "finished test on 20"

cp stars-21.txt stars.txt
cp astronomy_parameters-21-small.txt astronomy_parameters.txt
