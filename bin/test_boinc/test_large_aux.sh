...
cp astronomy_parameters-12-aux.txt astronomy_parameters.txt

./$1 -np 20 -p 0.571713 12.312119 -3.305187 148.010257 22.453902 0.42035 -0.468858 0.760579 -1.361644 177.884238 23.882892 1.210639 -1.611974 8.534378 -1.361644 177.884238 10.882892 1.210639 -1.611974 8.534378 
echo "finished test on 12 aux"

cp stars-20.txt stars.txt
cp astronomy_parameters-20-aux.txt astronomy_parameters.txt

./$1 -np 14 -p 0.571713 12.312119 -3.305187 148.010257 22.453902 0.42035 -0.468858 0.760520 -1.361644 177.884238 23.882892 1.210639 -1.611974 8.534378 
echo "finished test on 20 aux"

cp stars-21.txt stars.txt
cp astronomy_parameters-21-aux.txt astronomy_parameters.txt

./$1 -np 14 -p 0.571713 12.312119 -3.305187 148.010257 22.453902 0.42035 -0.468858 0.760579 -1.361644 177.884238 23.882892 1.210639 -1.611974 8.534378 
echo "finished test on 21 aux"

cp stars-79.txt stars.txt
cp astronomy_parameters-79-aux.txt astronomy_parameters.txt
...
cp astronomy_parameters-82-aux.txt astronomy_parameters.txt
...
cp astronomy_parameters-86-aux.txt astronomy_parameters.txt
